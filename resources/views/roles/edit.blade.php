            ...
            <div class="bg-white overflow-hidden shadow-2xl sm:rounded-3xl border border-gray-100">
                <div class="p-8">
                    <div class="flex items-center justify-between mb-8 border-b border-gray-100 pb-6">
                        <div>
                            <h3 class="text-2xl font-black text-gray-900 tracking-tight">Edit Role: <span class="text-blue-600">{{ $role->name }}</span></h3>
                            <p class="text-sm text-gray-500 mt-1 font-medium">Modify access levels and system permissions</p>
                        </div>
                    ...
                    <form action="{{ route('roles.update', $role->id) }}" method="POST">
                        ...
                        <div class="mb-10 lg:w-1/3">
                            ...
                            <div class="relative group">
                                ...
                                <input type="text" name="name" id="name" value="{{ $role->name }}" placeholder="e.g., Inventory Manager" 
                                    class="pl-11 block w-full rounded-2xl border-gray-100 bg-gray-50/50 shadow-inner focus:border-blue-500 focus:ring-blue-500/20 py-4 font-bold text-gray-900 transition-all" required>
                            </div>
                            @error('name')
                        ...
                        <div class="mb-10">
                            ...
                            @include('roles.partials.permission-matrix', ['permissions' => $permissions, 'role' => $role])
                        </div>
